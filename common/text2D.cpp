...
unsigned int vertexUUD;                   // Location of the program's "vertexUV" attribute
...
void initText2D(const char * texturePath){
	...
	vertexUUD = glGetAttribLocation(Text2DShaderID, "vertexUV");
...
void printText2D(const char * text, int x, int y, int size){
	...
	glEnableVertexAttribArray(vertexUUD);
	glBindBuffer(GL_ARRAY_BUFFER, Text2DUVBufferID);
	glVertexAttribPointer(vertexUUD, 2, GL_FLOAT, GL_FALSE, 0, (void*)0 );
	...
	glDisableVertexAttribArray(vertexUUD);
